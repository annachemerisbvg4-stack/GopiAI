...
from gopiai.app.exceptions import TokenLimitExceeded
from gopiai.core.logging import get_logger
logger = get_logger().logger
from gopiai.app.prompt.toolcall import NEXT_STEP_PROMPT, SYSTEM_PROMPT
from gopiai.app.schema import TOOL_CHOICE_TYPE, AgentState, Message, ToolCall, ToolChoice
from gopiai.app.tool import CreateChatCompletion, Terminate, ToolCollection
...
class ToolCallAgent(ReActAgent):
    ...
    def __init__(self, **data):
        ...
        self.tools.add_tool(CreateChatCompletion())
    ...
    async def execute_tool(self, command: ToolCall) -> str:
        ...
        name = command.function.name
        if name not in self.tools.tool_map:
        ...
        try:
            ...
            result = await self.tools.execute(name=name, tool_input=args)
