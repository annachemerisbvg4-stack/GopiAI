...
class SimpleIconManager:
    ...
    def __init__(self):
      ...
      def _init_lucide_manager(self):
        ...
        paths = [
            Path(__file__).parent.parent.parent / "GopiAI-Widgets" / "gopiai" / "widgets" / "managers" / "lucide_icon_manager.py",
            Path(__file__).parent.parent.parent / "GopiAI-Widgets" / "gopiai" / "widgets" / "core" / "icon_adapter.py",
                ...
                try:
                    ...
                    if "gopiai" in str(path):
                        ...
                        if spec is not None and spec.loader is not None:
                            ...
                            print(f"⚠️ Не удалось загрузить модуль из {path}")
                            continue
