...
try:
    ...
    from gopiai.widgets.managers.theme_manager import ThemeManager as AppThemeManager
    logger.info("Импортирован ThemeManager из gopiai.widgets.managers.theme_manager")
    imported_theme_manager = True
    app_theme_manager = AppThemeManager
except ImportError as e:
    logger.warning(f"Не удалось импортировать ThemeManager из gopiai.widgets.managers.theme_manager: {e}")
    try:
        ...
        from gopiai.widgets.managers.theme_manager import ThemeManager as AppThemeManager
        logger.info("Импортирован ThemeManager из gopiai.core.simple_theme_manager")
        imported_theme_manager = True
        app_theme_manager = AppThemeManager
    except ImportError as e:
