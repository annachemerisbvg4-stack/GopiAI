...
"""
Пример использования специализированного браузерного агента.
"""
...
class BrowserAgentWindow(QMainWindow):
    """Окно для демонстрации специализированного браузерного агента."""
    ...
    def __init__(self):
        ...
        # Настраиваем окно
        self.setWindowTitle("Специализированный браузерный агент")
