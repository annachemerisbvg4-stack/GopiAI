...
GRIP_SIZE = 10  # Единая толщина для всех сторон
...
class CustomGrip(QWidget):
    def __init__(self, parent, position, disable_color = False):
        ...
        if position == Qt.TopEdge:
            ...
            self.wi.bottom(self)
            self.setGeometry(0, self.parent.height() - GRIP_SIZE, self.parent.width(), GRIP_SIZE)
            self.setMaximumHeight(GRIP_SIZE)
            ...
            self.wi.left(self)
            self.setGeometry(0, 0, GRIP_SIZE, self.parent.height())
            ...
            self.wi.right(self)
            self.setGeometry(self.parent.width() - GRIP_SIZE, 0, GRIP_SIZE, self.parent.height())
            self.setMaximumWidth(GRIP_SIZE)
    ...
    def resizeEvent(self, event):
        if self.position == Qt.TopEdge and hasattr(self.wi, 'container_top'):
            self.wi.container_top.setGeometry(0, 0, self.width(), GRIP_SIZE)
        elif self.position == Qt.BottomEdge and hasattr(self.wi, 'container_bottom'):
            self.wi.container_bottom.setGeometry(0, 0, self.width(), GRIP_SIZE)
        elif self.position == Qt.LeftEdge and hasattr(self.wi, 'leftgrip'):
            self.wi.leftgrip.setGeometry(0, 0, GRIP_SIZE, self.height())
        elif self.position == Qt.RightEdge and hasattr(self.wi, 'rightgrip'):
            self.wi.rightgrip.setGeometry(0, 0, GRIP_SIZE, self.height())
...
class Widgets(object):
    def top(self, Form):
        ...
        self.container_top.setGeometry(QRect(0, 0, 500, GRIP_SIZE))
        self.container_top.setMinimumSize(QSize(0, GRIP_SIZE))
        self.container_top.setMaximumSize(QSize(16777215, GRIP_SIZE))
        ...
        self.top_left.setMinimumSize(QSize(GRIP_SIZE, GRIP_SIZE))
        self.top_left.setMaximumSize(QSize(GRIP_SIZE, GRIP_SIZE))
        ...
        self.top_right.setMinimumSize(QSize(GRIP_SIZE, GRIP_SIZE))
        self.top_right.setMaximumSize(QSize(GRIP_SIZE, GRIP_SIZE))
    ...
    def bottom(self, Form):
        ...
        self.container_bottom.setGeometry(QRect(0, 0, 500, GRIP_SIZE))
        self.container_bottom.setMinimumSize(QSize(0, GRIP_SIZE))
        self.container_bottom.setMaximumSize(QSize(16777215, GRIP_SIZE))
        ...
        self.bottom_left.setMinimumSize(QSize(GRIP_SIZE, GRIP_SIZE))
        self.bottom_left.setMaximumSize(QSize(GRIP_SIZE, GRIP_SIZE))
        ...
        self.bottom_right.setMinimumSize(QSize(GRIP_SIZE, GRIP_SIZE))
        self.bottom_right.setMaximumSize(QSize(GRIP_SIZE, GRIP_SIZE))
    ...
    def left(self, Form):
        ...
        self.leftgrip.setGeometry(QRect(0, 0, GRIP_SIZE, 500))
        self.leftgrip.setMinimumSize(QSize(GRIP_SIZE, 0))
    ...
    def right(self, Form):
        ...
        self.rightgrip.setGeometry(QRect(0, 0, GRIP_SIZE, 500))
        self.rightgrip.setMinimumSize(QSize(GRIP_SIZE, 0))
